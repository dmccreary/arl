...
one(){
	...
	echo "First verify the servo will center streight by entering 330."
	echo "Then calibrate the left turn max value. This is typically around 420."
        echo "Finally verity the max right.  This is typically around 240."
	echo "When you are done press q to quit"
	echo "You can run the following command from the shell:"
